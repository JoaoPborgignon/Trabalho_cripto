...
public class Jdialog_caracteres extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jdialog_caracteres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdialog_caracteres dialog = new Jdialog_caracteres(new javax.swing.JFrame(), true);

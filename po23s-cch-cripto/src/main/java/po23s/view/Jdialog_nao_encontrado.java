...
public class Jdialog_nao_encontrado extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Jdialog_nao_encontrado
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jdialog_nao_encontrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdialog_nao_encontrado dialog = new Jdialog_nao_encontrado(new javax.swing.JFrame(), true);
